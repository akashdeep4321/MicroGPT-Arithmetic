...
dataset_train = load_dataset("akash-deep321/Jason-Scratchpadded-2", split="train")
...
LOAD_PATH = "/kaggle/input/datasets/akashdeep321/250k-step-logger/logger.pt"
SAVE_PATH = "logger.pt"
SAVE_STEPS = 300_000
...
block_size = 220 # number of tokens in 1 scratchpad
